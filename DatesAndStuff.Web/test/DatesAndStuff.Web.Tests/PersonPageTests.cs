...
public class PersonPageTests
{
    ...
    public void Person_SalaryIncrease_ShouldIncrease(double percentage, double expectedSalary)
    {
        ...
        wait.Until(ExpectedConditions.ElementToBeClickable(By.XPath("//*[@data-test='SalaryIncreasePercentageInput']")));
        
        driver.FindElement(By.XPath("//*[@data-test='SalaryIncreasePercentageInput']")).Clear();
        driver.FindElement(By.XPath("//*[@data-test='SalaryIncreasePercentageInput']")).SendKeys(percentage.ToString());
